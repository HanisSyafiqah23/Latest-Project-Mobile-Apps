...
import com.example.waveoffoodorder.Fragment.CongratsBottomSheet
import com.example.waveoffoodorder.databinding.ActivityPayOutBinding
import com.example.waveoffoodorder.Model.OrderDetails
...
class PayOutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        totalAmount = calculateTotalAmount().toString() +"RM"
    ...
    private fun calculateTotalAmount(): Int {
        ...
        for ( i in 0 until foodItemPrice.size){
            ...
            val priceIntVale = if (lastChar == 'R'){
